...
#define M2M_V11_I2C_DEV             "/dev/i2c-1"
#define M2M_V11_SPI_DEV             "/dev/spidev0.0"

#define M2M_V11_I2C_OFFSET  2
#define M2M_V11_SPI_OFFSET  3
#define M2M_V11_PWM_OFFSET  2
