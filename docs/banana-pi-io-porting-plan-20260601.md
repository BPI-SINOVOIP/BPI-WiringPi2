...
| --- | --- | --- |
| BPI-R3 / R3 Mini / R64 / R4 / R4 Lite / R4 Pro | todo | Add only if the board exposes a documented 40-pin or service GPIO header useful to WiringPi. |
...
Continue Batch C from `BPI-M7 / W3 / AIM7 / LM7`.

Resume sequence:

1. Confirm RK3588 GPIO bank base addresses, GPIO v2 register compatibility, and
   the exact 40-pin/carrier maps for `BPI-M7 / W3 / AIM7 / LM7`.
2. Add one board or exact carrier alias set in this repo, build-test, commit,
   and push.
3. Add the same board in `RPi.GPIO`, build-test, commit, and push.
4. If the RK3588 backend or carrier map is not reliable from available sources,
