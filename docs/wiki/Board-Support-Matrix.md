...
BPI-F4, BPI-SM10 and BPI-CanMV-K230D Zero all remain `limited` until named production images and safe real-hardware digital-I/O logs exist. F4 pull is still a no-op; SM10 and K230D pull logic is source-backed but untested; alternate functions, PWM and bus device nodes are not claimed as hardware-validated.
